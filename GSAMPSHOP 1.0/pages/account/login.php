                    ...
                    <div class="card bg-dark text-white" style="border-radius: 1rem;">
                        <div class="card-body p-5 text-center">
                            <div class="mb-md-5 pb-5">
                                <h3 class="text-center"><i class="fas fa-sign-in-alt"></i> เข้าสู่ระบบ</h3>
                                ...
                                <button class="btn btn-outline-light btn-lg px-5" id="submit_login" type="button">เข้าสู่ระบบ</button>
                            ...
                            <div>
                                <p class="mb-0">ยังไม่มีบัญชี? <a href="/register" class="text-white-50 fw-bold">สมัครสมาชิก</a></p>
                            </div>
                        </div>
                    </div>
                </div>
